...
export const AuthView: React.FC = () => {
  const { login, googleSignIn, otpRequest, otpVerify, signup, biometricLogin, biometricActive, loadDemoUser } = useAuth();
          ...
          {activeTab === 'login' ? (
            <div className="space-y-6">
              ...
              <button
                ...
                disabled={isSubmitting}
                className="w-full py-3.5 px-4 rounded-xl bg-white/5 hover:bg-white/10 text-white font-bold border border-white/10 shadow-lg text-sm flex items-center justify-center gap-3 hover:scale-[1.02] active:scale-[0.98] transition-all"
              >
              ...
              <button
                ...
                className="w-full py-3 px-4 rounded-xl bg-gradient-to-r from-cyber-green/10 via-cyber-gold/10 to-cyber-blue/10 hover:from-cyber-green/20 hover:via-cyber-gold/20 hover:to-cyber-blue/20 text-slate-300 hover:text-white font-semibold border border-white/5 text-xs flex items-center justify-center gap-2 hover:scale-[1.02] active:scale-[0.98] transition-all"
              >
                <Award className="w-3.5 h-3.5 text-cyber-gold" />
                Quick Demo Account
              </button>
